...
def visualize_trajectory_2d(pose,feature_locations=None,prior=None,path_name="Unknown",show_ori=False):
  '''
  ...
  if feature_locations is not None:
    ax.scatter(feature_locations[0,:],feature_locations[1,:],c='g',s=1)
  if prior is not None:
      ax.scatter(prior[0,:],prior[1,:],c='b',s=1)
  if show_ori:
